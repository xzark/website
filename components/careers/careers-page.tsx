  ...
  async function handleSubmit() {
    ...
    try {
      const payload: CareersApplicationPayload = {
        jobId: job.slug,
        candidate: { name: values.name ?? "", email: values.email ?? "", phone: values.phone ?? "", location: values.location ?? "" },
