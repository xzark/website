...
export default function AboutPage() {
  return (
    <>
      ...
      <Header />
      <main>
        <PageHero eyebrow={<LocaleText pt="Sobre a xZark" en="About xZark" />} title={<LocaleText pt={<>Infraestrutura de segurança com <span className="font-serif italic text-primary">clareza</span>.</>} en={<>Security infrastructure with <span className="font-serif italic text-primary">clarity</span>.</>} />} description={<LocaleText pt="A xZark é uma iniciativa dedicada a explorar produtos e serviços de cibersegurança e privacidade para empresas modernas." en="xZark explores cybersecurity and privacy products and services for modern companies." />} />
