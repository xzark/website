...
const sections: LegalSection[] = [
  { id: "scope", title: "Escopo", content: <p>Estes termos se aplicam ao uso do site público xzark.co, seus conteúdos e formulários públicos.</p> },
...
export default function TermsPage() { return <LegalPage eyebrow="Documento legal" title={<>Termos de <span className="font-serif italic text-primary">Uso</span>.</>} description="Condições para uso do site público xZark." lastUpdated="[DATA DE ATUALIZAÇÃO]" sections={sections} /> }
